...
lyg.boxYear=function(){var today=lyg.getYear(),boxYear=[],t={};t["value"]=today;t["text"]=today+"届";t["desc"]="";t["selected"]=true;boxYear.push(t);for(i=1;i<5;i++){var e={};today=today-1;e["value"]=today;e["text"]=today+"届";e["desc"]="";boxYear.push(e);}return boxYear;}
/**
 * 毫秒数转时间
